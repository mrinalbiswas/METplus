.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_generated_met_tool_wrapper_RegridDataPlane_RegridDataPlane_multi_field_one_file.py>`     to download the full example code
    .. rst-class:: sphx-glr-example-title

    .. _sphx_glr_generated_met_tool_wrapper_RegridDataPlane_RegridDataPlane_multi_field_one_file.py:
...
Process all fields in a single call to RegridDataPlane
...
1) Passing in RegridDataPlane_multi_field_one_file.conf then a user-specific system configuration file::
       ...
       master_metplus.py -c /path/to/METplus/parm/use_cases/met_tool_wrapper/RegridDataPlane/RegridDataPlane_multi_field_one_file.conf -c /path/to/user_system.conf

2) Modifying the configurations in parm/metplus_config, then passing in RegridDataPlane_multi_field_one_file.conf::

       master_metplus.py -c /path/to/METplus/parm/use_cases/met_tool_wrapper/RegridDataPlane/RegridDataPlane_multi_field_one_file.conf
...
.. _sphx_glr_download_generated_met_tool_wrapper_RegridDataPlane_RegridDataPlane_multi_field_one_file.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download sphx-glr-download-python
     ...
     :download:`Download Python source code: RegridDataPlane_multi_field_one_file.py <RegridDataPlane_multi_field_one_file.py>`



  .. container:: sphx-glr-download sphx-glr-download-jupyter

     :download:`Download Jupyter notebook: RegridDataPlane_multi_field_one_file.ipynb <RegridDataPlane_multi_field_one_file.ipynb>`
