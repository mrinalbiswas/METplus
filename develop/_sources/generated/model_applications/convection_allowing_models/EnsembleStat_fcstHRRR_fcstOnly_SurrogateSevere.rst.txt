.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_generated_model_applications_convection_allowing_models_EnsembleStat_fcstHRRR_fcstOnly_SurrogateSevere.py>`     to download the full example code
    .. rst-class:: sphx-glr-example-title

    .. _sphx_glr_generated_model_applications_convection_allowing_models_EnsembleStat_fcstHRRR_fcstOnly_SurrogateSevere.py:
...
.. _sphx_glr_download_generated_model_applications_convection_allowing_models_EnsembleStat_fcstHRRR_fcstOnly_SurrogateSevere.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download sphx-glr-download-python
     ...
     :download:`Download Python source code: EnsembleStat_fcstHRRR_fcstOnly_SurrogateSevere.py <EnsembleStat_fcstHRRR_fcstOnly_SurrogateSevere.py>`



  .. container:: sphx-glr-download sphx-glr-download-jupyter

     :download:`Download Jupyter notebook: EnsembleStat_fcstHRRR_fcstOnly_SurrogateSevere.ipynb <EnsembleStat_fcstHRRR_fcstOnly_SurrogateSevere.ipynb>`
