.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_generated_model_applications_space_weather_GenVxMask_fcstGloTEC_FcstOnly_solar_altitude.py>`     to download the full example code
    .. rst-class:: sphx-glr-example-title

    .. _sphx_glr_generated_model_applications_space_weather_GenVxMask_fcstGloTEC_FcstOnly_solar_altitude.py:
...
.. _sphx_glr_download_generated_model_applications_space_weather_GenVxMask_fcstGloTEC_FcstOnly_solar_altitude.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download sphx-glr-download-python
     ...
     :download:`Download Python source code: GenVxMask_fcstGloTEC_FcstOnly_solar_altitude.py <GenVxMask_fcstGloTEC_FcstOnly_solar_altitude.py>`



  .. container:: sphx-glr-download sphx-glr-download-jupyter

     :download:`Download Jupyter notebook: GenVxMask_fcstGloTEC_FcstOnly_solar_altitude.ipynb <GenVxMask_fcstGloTEC_FcstOnly_solar_altitude.ipynb>`
