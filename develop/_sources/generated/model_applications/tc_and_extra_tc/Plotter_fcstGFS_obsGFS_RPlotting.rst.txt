.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_generated_model_applications_tc_and_extra_tc_Plotter_fcstGFS_obsGFS_RPlotting.py>`     to download the full example code
    .. rst-class:: sphx-glr-example-title

    .. _sphx_glr_generated_model_applications_tc_and_extra_tc_Plotter_fcstGFS_obsGFS_RPlotting.py:
...
.. _sphx_glr_download_generated_model_applications_tc_and_extra_tc_Plotter_fcstGFS_obsGFS_RPlotting.py:
